...
describeDeployment(__filename, () => {
    ...
    const TKN_DEPOSIT_LIMIT_USD = 171_000 * CENTS;
    const BNT_FUNDING_LIMIT_USD = 156_000 * CENTS;
    const DEPOSIT_LIMIT = toWei(TKN_DEPOSIT_LIMIT_USD).div(NATIVE_TOKEN_PRICE_IN_CENTS);
    const FUNDING_LIMIT = toWei(BNT_FUNDING_LIMIT_USD).div(BNT_TOKEN_PRICE_IN_CENTS);
