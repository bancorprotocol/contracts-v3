import { BancorNetwork, ExternalProtectionVault, OmniVault, ProxyAdmin } from '../../components/Contracts';
...
describeDeployment('1642682506-network', ContractName.BancorNetworkV1, () => {
    ...
    it('should deploy and configure the network contract', async () => {
        ...
        await expectRoleMembers(omniVault, Roles.Upgradeable.ROLE_ADMIN, [deployer, network.address]);
        ...
        await expectRoleMembers(omniVault, Roles.Vault.ROLE_ASSET_MANAGER, [network.address]);
