import Contracts, { IERC20, MasterVault, TestBancorNetwork, TestOmniPool } from '../../components/Contracts';
...
describe('MasterVault', () => {
    ...
    describe('construction', () => {
        ...
        beforeEach(async () => {
            ({ network, bntGovernance, vbntGovernance, masterVault, omniPool } = await createSystem());
        });
