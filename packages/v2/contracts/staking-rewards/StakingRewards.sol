        ...
        return
            poolRewardsData.rewardPerToken.add( // the aggregated reward rate
                ...
                .sub(stakingStartTime) // the duration of the staking
                    ...
                    .div(totalReserveAmount.mul(PPM_RESOLUTION)) // multiplied by the rate // and factored to increase precision // and applied the specific token share of the whole reward // and divided by the total protected tokens amount in the pool
            );
    }
