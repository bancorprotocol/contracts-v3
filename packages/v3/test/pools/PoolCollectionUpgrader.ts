...
import { ZERO_ADDRESS, Symbols, TokenNames } from '../../utils/Constants';
...
describe('PoolCollectionUpgrader', () => {
    ...
    describe('pool upgrade', () => {
        ...
        it('should revert when attempting upgrade a pool with an unsupported version', async () => {
            ...
            const reserveToken3 = await Contracts.TestERC20Token.deploy(TokenNames.TKN, Symbols.TKN, 1_000_000);
