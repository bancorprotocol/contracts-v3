...
const getContracts = (signer?: Signer) => ({
    ...
    TestArbitrageFormula: deployOrAttach<TestArbitrageFormula__factory>('TestArbitrageFormula', signer),
    TestDefaultFormula: deployOrAttach<TestDefaultFormula__factory>('TestDefaultFormula', signer),
    TestThresholdFormula: deployOrAttach<TestThresholdFormula__factory>('TestThresholdFormula', signer),
