...
import {
    ...
    TestArbFormula__factory,
    TestDefFormula__factory,
...
const getContracts = (signer?: Signer) => ({
    ...
    TestArbFormula: deployOrAttach<TestArbFormula__factory>('TestArbFormula', signer),
    TestDefFormula: deployOrAttach<TestDefFormula__factory>('TestDefFormula', signer),
