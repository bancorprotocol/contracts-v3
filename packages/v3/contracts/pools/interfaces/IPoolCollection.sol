...
struct WithdrawalAmounts {
    ...
    uint256 baseTokenAmountToTransferFromExternalProtectionVaultToProvider; // the base token amount to transfer from the external protection wallet to the provider
