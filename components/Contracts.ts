...
const getContracts = (signer?: Signer) => ({
    ...
    OmniPool: deployOrAttach('OmniPool', OmniPool__factory, signer),
    OmniVault: deployOrAttach('OmniVault', OmniVault__factory, signer),
    ...
    TestOmniPool: deployOrAttach('TestOmniPool', TestOmniPool__factory, signer),
