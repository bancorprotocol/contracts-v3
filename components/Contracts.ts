...
import {
    ...
    MockExchangesNegativeOutput__factory,
...
const getContracts = (signer?: Signer) => ({
    ...
    MockExchangesNegativeOutput: deployOrAttach('MockExchangesNegativeOutput', MockExchangesNegativeOutput__factory, signer),
