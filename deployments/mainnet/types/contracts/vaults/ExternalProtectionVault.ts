...
export interface ExternalProtectionVaultInterface extends utils.Interface {
  functions: {
...
export interface ExternalProtectionVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExternalProtectionVaultInterface;
