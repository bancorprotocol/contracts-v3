...
export type FlashLoanCompletedEvent = TypedEvent<
    ...
    { token: string; borrower: string; amount: BigNumber; feeAmount: BigNumber }
>;
...
export type LatestPoolCollectionReplacedEvent = TypedEvent<
    ...
    { poolType: number; prevPoolCollection: string; newPoolCollection: string }
>;
...
export type PoolAddedEvent = TypedEvent<[string, string], { pool: string; poolCollection: string }>;

export type PoolAddedEventFilter = TypedEventFilter<PoolAddedEvent>;

export type PoolCollectionAddedEvent = TypedEvent<[number, string], { poolType: number; poolCollection: string }>;

export type PoolCollectionAddedEventFilter = TypedEventFilter<PoolCollectionAddedEvent>;

export type PoolCollectionRemovedEvent = TypedEvent<[number, string], { poolType: number; poolCollection: string }>;
...
export interface BancorNetwork extends BaseContract {
    ...
    callStatic: {
        ...
        cancelWithdrawal(id: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        withdrawNetworkFees(recipient: string, overrides?: CallOverrides): Promise<void>;
    };
