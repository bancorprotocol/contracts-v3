...
export interface BancorNetworkInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "addPoolCollection",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "latestPoolCollection",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setLatestPoolCollection",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "LatestPoolCollectionReplaced"
  ): EventFragment;
...
export type LatestPoolCollectionReplacedEventFilter =
  TypedEventFilter<LatestPoolCollectionReplacedEvent>;
...
export type PoolAddedEvent = TypedEvent<
  [string, string],
  { pool: string; poolCollection: string }
>;
...
export type PoolCollectionAddedEvent = TypedEvent<
  [number, string],
  { poolType: number; poolCollection: string }
>;
