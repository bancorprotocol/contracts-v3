...
export interface PoolCollectionInterface extends utils.Interface {
  ...
  events: {
    ...
    "PoolMigratedIn(address)": EventFragment;
    "PoolMigratedOut(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "PoolMigratedIn"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "PoolMigratedOut"): EventFragment;
...
export type DefaultTradingFeePPMUpdatedEvent = TypedEvent<
  [number, number],
  DefaultTradingFeePPMUpdatedEventObject
>;
...
export type DepositingEnabledEvent = TypedEvent<
  [string, boolean],
  DepositingEnabledEventObject
>;
...
export interface PoolMigratedInEventObject {
  token: string;
}
export type PoolMigratedInEvent = TypedEvent<
  [string],
  PoolMigratedInEventObject
>;

export type PoolMigratedInEventFilter = TypedEventFilter<PoolMigratedInEvent>;

export interface PoolMigratedOutEventObject {
  token: string;
}
export type PoolMigratedOutEvent = TypedEvent<
  [string],
  PoolMigratedOutEventObject
>;

export type PoolMigratedOutEventFilter = TypedEventFilter<PoolMigratedOutEvent>;
...
export type TotalLiquidityUpdatedEventFilter =
  TypedEventFilter<TotalLiquidityUpdatedEvent>;
...
export type TradingLiquidityUpdatedEventFilter =
  TypedEventFilter<TradingLiquidityUpdatedEvent>;
...
export interface PoolCollection extends BaseContract {
  ...
  filters: {
    ...
    "PoolMigratedIn(address)"(token?: string | null): PoolMigratedInEventFilter;
    PoolMigratedIn(token?: string | null): PoolMigratedInEventFilter;

    "PoolMigratedOut(address)"(
      token?: string | null
    ): PoolMigratedOutEventFilter;
    PoolMigratedOut(token?: string | null): PoolMigratedOutEventFilter;
