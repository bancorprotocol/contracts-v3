...
export interface StandardRewardsInterface extends utils.Interface {
  functions: {
    ...
    "resetProgram(uint256,address[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isProgramActive",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "isProgramEnabled",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "latestProgramId",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "programIds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "programRewards",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "programStake",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "terminateProgram",
    values: [BigNumberish]
  ): string;
...
export type ProgramEnabledEvent = TypedEvent<
  [string, BigNumber, boolean, BigNumber],
  ProgramEnabledEventObject
>;
...
export type ProgramTerminatedEvent = TypedEvent<
  [string, BigNumber, number, BigNumber],
  ProgramTerminatedEventObject
>;

export type ProgramTerminatedEventFilter =
  TypedEventFilter<ProgramTerminatedEvent>;
...
export type ProviderLeftEvent = TypedEvent<
  [string, BigNumber, string, BigNumber, BigNumber],
  ProviderLeftEventObject
>;
...
export interface StandardRewards extends BaseContract {
  ...
  functions: {
    ...
    programs(
      ids: BigNumberish[],
      overrides?: CallOverrides
    ): Promise<[ProgramDataStructOutput[]]>;
  ...
  callStatic: {
    ...
    stakeRewards(
      ids: BigNumberish[],
      overrides?: CallOverrides
    ): Promise<StakeAmountsStructOutput>;
