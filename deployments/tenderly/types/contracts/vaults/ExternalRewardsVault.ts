...
export interface ExternalRewardsVaultInterface extends utils.Interface {
  functions: {
...
export interface ExternalRewardsVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExternalRewardsVaultInterface;
