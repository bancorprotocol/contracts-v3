...
import { WithdrawalReturn } from "../../pools/interfaces/IPoolCollection.sol";
...
interface IBancorNetworkInfo is IUpgradeable {
     ...
     */
    function withdrawalAmounts(IPoolToken poolToken, uint256 poolTokenAmount) external view returns (WithdrawalReturn memory);
}
